...
_BODY = [
    ...
    (4, 0, _DARK),  (7, 0, _DARK),
    # Head (yellow)
    (3, 1, _ORANGE), (4, 1, _ORANGE), (5, 1, _ORANGE),
    (6, 1, _ORANGE), (7, 1, _ORANGE), (8, 1, _ORANGE),
    # Stripe 1 — dark
    (3, 2, _DARK),  (4, 2, _DARK),  (5, 2, _DARK),
    (6, 2, _DARK),  (7, 2, _DARK),  (8, 2, _DARK),
    # Stripe 2 — yellow
    (3, 3, _ORANGE), (4, 3, _ORANGE), (5, 3, _ORANGE),
    (6, 3, _ORANGE), (7, 3, _ORANGE), (8, 3, _ORANGE),
    # Stripe 3 — dark
    (3, 4, _DARK),  (4, 4, _DARK),  (5, 4, _DARK),
    (6, 4, _DARK),  (7, 4, _DARK),  (8, 4, _DARK),
    # Stripe 4 — yellow
    (3, 5, _ORANGE), (4, 5, _ORANGE), (5, 5, _ORANGE),
    (6, 5, _ORANGE), (7, 5, _ORANGE), (8, 5, _ORANGE),
    # Tail — dark
    (3, 6, _DARK),  (4, 6, _DARK),  (5, 6, _DARK),
    (6, 6, _DARK),  (7, 6, _DARK),  (8, 6, _DARK),
    # Stinger
    (5, 7, _ORANGE), (6, 7, _ORANGE),
]
